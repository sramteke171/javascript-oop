...
We probably don't want to create an object literal (`{}`) for every new car, though we will want some way of representing each car inside of our application.

Every car object is going to have some common characteristics and some makes and models might have distinct characteristics.
